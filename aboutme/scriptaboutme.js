const irantext = document.querySelector("#iran");
const iranimg = document.querySelector("#iranimg");
const russflag = document.querySelector(".rusflag");

russflag.addEventListener("dblclick", ()=>{
    russflag.src="https://wallpapercave.com/wp/wp3867035.jpg";
})



irantext.addEventListener("mouseenter", ()=>{
    iranimg.style.opacity="1";
})

irantext.addEventListener("mouseleave", ()=>{
    iranimg.style.opacity="0";
})
